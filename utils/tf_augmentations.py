...
from utils.tf_general import LOGGER#, check_version, colorstr, resample_segments, segment2box, xywhn2xyxy
# from utils.metrics import bbox_ioa
from utils.tf_general import colorstr
...
class Albumentations:
    ...
    def __init__(self, size=640):
        ...
        try:
            ...
            T = [
                ...
                A.RandomGamma(p=0.0),
                A.ImageCompression(quality_lower=75, p=0)]  # transforms
    ...
    def __call__(self, im, labels, p=1.0):
        if self.transform and random.random() < p:
            # labels = np.array([[3,0.1,0.2,0.3,0.4]])
